...
Haupt-Dashboard der Phasely-App.
Zeigt die aktuelle Zyklusphase, Trainingsverteilung und ermöglicht das Erstellen einer Trainingswoche.
"""
...
from src.interface_components import (
    h1, h2, h3, textblock,
    view_score_percentage, info_card, button
)
...
# Initialer Wert für Session-State (falls nicht gesetzt)
if "current_subject" not in st.session_state:
    st.session_state.current_subject = "No subject selected"
...
textblock(
    ...
    "Hier bekommst du reichlich Infos über deine Zyklusphasen und die optimale Trainingsgestaltung während dieser Phasen. "
    "Du kannst sogar Sporteinheiten auswählen und sehen, wie gut sie zu deiner aktuellen Phase passen. Viel Spaß!"
)
st.markdown("---")
...
#%% Trainingsverteilung (Soll-Werte)
...
with col1:
    info_card(
        ...
        "Dein Zyklus beeinflusst Energie, Belastbarkeit und Regeneration. "
        "Ein Training, das auf deine jeweilige Phase abgestimmt ist, kann effektiver, nachhaltiger und angenehmer sein."
    )
with col2:
    info_card(
        "Wie funktioniert das?",
        "Je nach Phase (z. B. Menstruation, Follikelphase) verändern sich Hormone, die dein Training beeinflussen. "
        "Phasely passt deine Workouts daran an und unterstützt dich mit datenbasierten Empfehlungen."
    )

#%% Button zum Aktivieren der Trainingsplanung
